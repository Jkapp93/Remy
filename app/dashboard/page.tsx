    ...
    <div style={{ background: '#0b0f14', minHeight: '100vh', color: '#e8edf2', fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-orange { background:rgba(240,122,46,0.06); border:1px solid rgba(240,122,46,0.25); animation:glow 3s ease-in-out infinite; }
      `}</style>
      ...
      <div style={{ padding:'40px 28px', maxWidth:'1000px', margin:'0 auto' }}>
        <div style={{ fontFamily:"'Syne', sans-serif", fontSize:'1.8rem', fontWeight:700, marginBottom:'8px' }}>
